...
-- Step 2: Update existing is_superadmin function to use security definer approach
...
-- Step 3: Drop and recreate user_roles policies
...
-- Step 4: Drop and recreate brokerages policies  
...
-- Step 5: Drop and recreate invitations policies
...
-- Step 6: Drop and recreate project_members policies
...
-- Step 7: Drop and recreate projects policies
