...
const CategoryBox = ({ name, onClick, completion }: CategoryBoxProps) => {
  ...
  return (
    <Card 
      className="cursor-pointer bg-white border border-form-border hover:border-form-green/40 transition-all duration-200 hover:shadow-lg rounded-[12px] shadow-sm"
      onClick={onClick}
    >
